...
<body style="width: 420; height: 700;">
	...
	<div style="width: 50%; height: 30%; float: right;">
		...
		<div>
			<img src='../images/correct.png' id='myimg' width='20' height='20'>
			<label>정답</label>&nbsp; <input type="text" id="OCount"
				style='width: 24;' value='0'>개 <br> <img
				src='../images/incorrect.png' id='myimg' width='20' height='20'>
			<label>오답</label>&nbsp; <input type="text" id="XCount"
				style='width: 24;' value='0'>번 <br> <img
				src='../images/clock.png' id='myimg' width='20' height='20'> <label>시간</label>&nbsp;
	...
	<script>
		var photo = [ '../images/bvb.png', '../images/mu.png',
				'../images/rm.png', '../images/bm.png',
				'../images/chelsea.png', '../images/barca.png',
				'../images/psg.png', '../images/monaco.png',
				'../images/ajax.png' ];
		var check = [ '도르트문트', '맨체스터 유나이티드', '레알 마드리드', '바이에른 뮌헨', '첼시',
				'바르셀로나', '파리 생제르망', 'AS 모나코', '아약스' ];
		var hintArr = [ 'ㄷㄹㅌㅁㅌ', 'ㅁㅊㅅㅌ ㅇㄴㅇㅌㄷ', 'ㄹㅇ ㅁㄷㄹㄷ', 'ㅂㅇㅇㄹ ㅁㅎ', 'ㅊㅅ',
				'ㅂㄹㅅㄹㄴ', 'ㅍㄹ ㅅㅈㄹㅁ', 'AS ㅁㄴㅋ', 'ㅇㅇㅅ' ];
									...
									.click(
											function() {
												...
												if ($('#answer').val() == check[random[index]]) {
													...
													$('#verify')
															.html(
																	'<font color=red>틀렸습니다!</font>');

													$('#hintCheck')
															.html(
																	'<font color=pink>'
																			+ hintArr[random[index]]
																			+ '</font>');
