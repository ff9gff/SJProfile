...
<html>
	...
	<body>
		...
		<script>
			function myMap() {
				myCenter = new google.maps.LatLng(37.362578, 127.110201);
				var mapOptions = {
					center : myCenter,
					zoom : 16,
					scrollwheel : false,
		...
		<script
			src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAO_hUH4xKYBB1mQq1wPJM9Ynq39C-AJpY&callback=myMap"></script>
		<!--
